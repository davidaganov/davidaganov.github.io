...
import { HABR_LINK } from "@base/constants"
...
const platformUrl = `${HABR_LINK}/articles`
...
<template>
  <AppRightSidebarProfile
    platform-icon="i-simple-icons-habr"
    platform-bg="bg-[#077fa3]"
    icon-color-class="size-2.5 text-white"
