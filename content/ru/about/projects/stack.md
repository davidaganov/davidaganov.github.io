...
> Для повседневной работы с несколькими репозиториями удобно подключить [Dock](/docs/about/projects/dock) — скрипты, git и терминал в одном окне, список проектов через тот же `projects.json`, что и в Project Manager.
